...
class TicTacToeView(
    ...
    private fun initAttributes(attributesSet: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        player1Color =
            typedArray.getColor(R.styleable.TicTacToeView_player1Color, PLAYER_1_DEFAULT_COLOR)
        player2Color =
            typedArray.getColor(R.styleable.TicTacToeView_player2Color, PLAYER_2_DEFAULT_COLOR)
    ...
    private fun drawCells(canvas: Canvas) {
        ...
        for (row in 0 until field.columns) {
    ...
    private fun updateViewSizes() {
        ...
        val cellHeight = safeWidth / field.rows.toFloat()
    ...
    companion object {
        const val PLAYER_1_DEFAULT_COLOR = Color.GREEN
        const val PLAYER_2_DEFAULT_COLOR = Color.RED
